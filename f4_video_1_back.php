...
<html>
    ...
    <body class="bg_color">
        ...
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group" style="margin-left: 35%;margin-top: 10px; margin-bottom: 10px; font-family:DFKai-sb;">
            <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" onclick="javascript:location.href='f4_video_1_front.php'">
            <label class="btn btn-outline-primary" for="btnradio1">正面</label>

            <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" onclick="javascript:location.href='f4_video_1_back.php'" checked>
