    ...
    <body class="bg_color">
        ...
        <table>
            <tr>
                ...
                <td>
                    <p class="function_title">請選擇細部部位(可複選)</p>
                </td>
            </tr>
        </table>
        <!--內容開始-->
        <form method="get" action="f1_choose_2_details2.php">  
            <!--選單-->
            <select name="f1_details" id="details" size="5" multiple="multiple" 
                style="width:88%; height: 88%;margin-left:20px; margin-top:20px; font-size:20px; font-family:DFKai-sb;">
                <option value="1">鼠蹊部</option>
                <option value="2">泌尿系統</option>
                <option value="3">生殖系統</option>
            </select>
            <!--其他：-->
        ...
        <!--內容結束-->   
            ...
            <div class="container">
                <div class="row">
                    <div class="col" style="padding-left:37%; padding-right:37%;">
                        <button class="change_page_btn" onclick="javascript:location.href='f1_choose_1_front.php'">上一頁</button>
                    </div>
                </div>    
            </div> 
    </body>
