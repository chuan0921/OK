    ...
    <body class="bg_color">
        ...
        <table>
            <tr>
                ...
                <td>
                    <p class="function_title">請問您今天有什麼不舒服的症狀呢？(可複選)</p>
                </td>
            </tr>
        </table> 
        <!--內容開始-->
        <form method="get" action="f1_choose_3_symptom2.php">  
            <!--選單-->
            <select name="f1_symptom" id="details" size="5" multiple="multiple" 
                style="width:88%; height: 88%;margin-left:20px; margin-top:20px; font-size:20px; font-family:DFKai-sb;">
                <option value="1">血尿</option>
                <option value="2">排尿灼熱</option>
                <option value="3">排尿困難</option>
                <option value="4">尿急</option>
                <option value="5">尿液混濁發臭</option>
                <option value="6">膀胱疼痛</option>
                <option value="7">膀胱脹痛</option>
                <option value="8">尿道分泌物增多</option>
            </select>
            <!--其他：-->
        ...
        <!--內容結束-->   
            ...
            <div class="container">
                <div class="row">
                    <div class="col" style="padding-left:37%; padding-right:37%;">
                        <button class="change_page_btn" onclick="javascript:location.href='f1_choose_2_details.php'">上一頁</button>
                    </div>
                </div>    
            </div> 
    </body>
